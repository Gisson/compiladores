// $Id: basic_ast_visitor.h,v 1.10 2016/03/18 16:27:51 ist179042 Exp $ -*- c++ -*-
...
public:
  ...
  virtual void do_variable_declaration_node(zu::variable_declaration_node * const node, int lvl) = 0;
