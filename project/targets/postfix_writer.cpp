...
void zu::postfix_writer::do_priority_node(zu::priority_node * const node, int lvl) {
    //FIXME
}
...
void zu::postfix_writer::do_function_def_node(zu::function_def_node * const node, int lvl) { //FIXME: BUG MIGHT BE IN THIS CODE(it calls itself main...)
